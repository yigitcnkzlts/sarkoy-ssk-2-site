export const siteConfig = {
  ...
  address: "Cumhuriyet Mah. SSK Sahil Sitesi 2. Kısım, Şarköy, Tekirdağ",
  ...
  map: {
    ...
    longitude: 27.141579,
    zoom: 16,
    placeName: "Şarköy SSK2 Sitesi",
    embedUrl:
      "https://maps.google.com/maps?q=40.614887,27.141579&hl=tr&z=16&output=embed",
    directionsUrl:
      "https://www.google.com/maps/dir/?api=1&destination=40.614887,27.141579&destination_place=Şarköy+SSK2+Sitesi",
  },
  stats: {
    blocks: 17,
    units: 308,
